export const Block_id_json = {
    "ID": {
        ...
        // フェンスゲート
        "minecraft:fence_gate": ["direction", "open_bit"],
        "minecraft:spruce_fence_gate": ["direction", "open_bit"],
        "minecraft:birch_fence_gate": ["direction", "open_bit"],
        "minecraft:jungle_fence_gate": ["direction", "open_bit"],
        "minecraft:acacia_fence_gate": ["direction", "open_bit"],
        "minecraft:dark_oak_fence_gate": ["direction", "open_bit"],
        "minecraft:mangrove_fence_gate": ["direction", "open_bit"],
        "minecraft:cherry_fence_gate": ["direction", "open_bit"],
        "minecraft:bamboo_fence_gate": ["direction", "open_bit"],
        "minecraft:crimson_fence_gate": ["direction", "open_bit"],
        "minecraft:warped_fence_gate": ["direction", "open_bit"],
        // 原木
